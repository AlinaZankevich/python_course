...
# 4. В файле «A_increase.py» напишите главную программу для создания последовательности (итерируемого объекта класса RangeIterable) из 32 строк возрастающей длины и поэлементного вывода ее с помощью цикла через короткие интервалы времени:
